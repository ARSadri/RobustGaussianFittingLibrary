...
## citation
 "A Python package based on robust statistical analysis for serial crystallography data processing",M. Hadian-Jazi and A. Sadri, Acta Crystallographica Section D, Sep, 2023
